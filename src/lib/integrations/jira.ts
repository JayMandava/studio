...
export async function createJiraStory(
  ...
  try {
    ...
    // Extract brief summary from requirement text (first sentence or up to 60 chars)
    const requirementText = requirement.requirement.replace(/REQ-[A-Z]+-\d+:\s*/, '');
  ...
  const content: any[] = [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'text', text: 'Each test case is created as a subtask below this requirement.' },
      ],
    },
    {
      type: 'rule',
