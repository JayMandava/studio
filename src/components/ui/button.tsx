    ...
    return (
      <Comp
        className={cn(
          ...
          "before:absolute before:inset-0 before:scale-95 before:rounded-full before:bg-primary/10 before:opacity-0 before:blur before:transition before:duration-200 before:ease-out group-hover:before:opacity-100 group-active:before:opacity-100",
          className
        )}
        ref={ref}
        {...props}
