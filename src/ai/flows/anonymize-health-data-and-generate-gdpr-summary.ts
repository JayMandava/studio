...
const anonymizeHealthDataPrompt = ai.definePrompt({
  ...
  4.  Suggest any missing information or steps to improve GDPR compliance. **Format this as a Markdown list. Make any subheadings bold by wrapping them in **, and ensure the subheading and its content are part of the same bullet point.**
